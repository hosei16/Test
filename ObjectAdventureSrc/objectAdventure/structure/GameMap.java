...
public class GameMap {
    ...
    /**
     * Returns a new Game Map. (A new instance is returned to prevent modifications to the global
     * map.)
     *
     ...
     * of the this class. In the absence of adding another "Wrapper Class" the signature of the main
