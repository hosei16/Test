...
public class Configuration_RoomList {
    ...
    private void initRooms() {
        ...
        // THE ITEM BELOW HAVE BEEN COMMENTED OUT BECUASE THE CLASS BEING REFERENCED DOES NOT EXIST IN THE REPOSITORY.
       // addRoom(new SuperAwesomeRoomFive());
        ...
        addRoom(new Room19());
        addRoom(new Room_31());
        //addRoom(new Room28()); // Commented out becuase Room28.java oes not exit in current commit. -AJC.
        addRoom(new HauntedRoom());
        addRoom(new Program1());
        addRoom(new Room25());
        
        // THE ITEM BELOW HAVE BEEN COMMENTED OUT BECUASE THE CLASS BEING REFERENCED DOES NOT EXIST IN THE REPOSITORY (mabdel6).
        // addRoom(new room4());
    }
}
